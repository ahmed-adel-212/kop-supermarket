                                    ...
                                    <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden"
                                        ...
                                        <a class="osahan-credits d-flex align-items-center p-3 bg-light"
                                           href="{{route('loyalty')}}">
                                            ...
                                            <h5 class="m-0 @if(app()->getLocale() == 'en') ml-auto @else mr-auto @endif text-primary">
                                                @if(isset($points))
                                                    {{$points['user_points']}}
                                                @endif
                                            </h5>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="bg-white card addresses-item mb-4 shadow">
                                                                    <div class="gold-members p-4">
                                                                        <div class="media">
                                                                            <div class="@if(app()->getLocale() == 'en') mr-3 @else ml-3 @endif"><i
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <label
                                                                                                            for="inputPassword4" class="text-dark">{{__('general.Delivery Area')}}</label>
                                                                                                        <div
                                                                                                            class="input-group">
                                                                                                            <input
                                                                                                                type="text"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <label
                                                                                                            for="inputPassword4" class="text-dark">
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="form-group col-md-12">
                                                                                                        <label
                                                                                                            for="inputPassword5" class="text-dark">{{__('general.Street')}}
                                                                                                        </label>
                                                                                                        <div
                                                                                                            class="input-group">
                                                                                                            <input
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="form-group col-md-12">
                                                                                                        <label
                                                                                                            for="inputPassword5" class="text-dark">
                                                                                                            {{__('general.BuildNo')}}
                                                                                                        </label>
                                                                                                        <div
                                                                                                            class="input-group">
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="form-group col-md-12">
                                                                                                        <label
                                                                                                            for="inputPassword6" class="text-dark">
                                                                                                            {{__('general.Landmark')}}
                                                                                                        </label>
                                                                                                        <div
                                                                                                            class="input-group">
