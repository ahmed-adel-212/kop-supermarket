                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 sm-padding">
                            <ul class="cart-total">
                                ...
                                @endif
                                <li><span>{{ __('general.Total') }} :</span>{{ $request->total }} {{ __('general.SR') }}
                                </li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="card-body">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="{{__('general.desc_label')}}" id="floatingTextarea2" style="height: 200px" name="description" value="{{old('description')}}"></textarea>
