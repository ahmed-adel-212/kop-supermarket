                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {!! $errors->first('title_ar', 'is-invalid') !!}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control {!! $errors->first('date_from', 'is-invalid') !!}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date To</label>
                                        <input type="datetime-local" class="form-control {!! $errors->first('date_to', 'is-invalid') !!}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {!! $errors->first('description', 'is-invalid') !!}" name="description">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="help-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {!! $errors->first('description_ar', 'is-invalid') !!}" name="description_ar">{{ old('description_ar') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control {!! $errors->first('discount_type', 'is-invalid') !!}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control {!! $errors->first('discount_value', 'is-invalid') !!}"
