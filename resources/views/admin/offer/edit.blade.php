                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleInputService" name="service_type">
                                            ...
                                            <option value="delivery" @if ($offer->service_type == 'delivery') selected @endif>
                                                Delivery</option>
                                            <option value="takeaway" @if ($offer->service_type == 'takeaway') selected @endif>Take
                                                awy</option>
                                        </select>
                                        @error('service_type')
                                            <div class="help-block">{{ $message }}</div>
                            ...
                            {{-- <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select2  {!! $errors->first('branches', 'is-invalid') !!}" multiple="multiple"
                                            data-placeholder="Select a branch" style="width: 100%;" name="branches[]">
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    @if ($offer->branches->contains($branch->id)) selected @endif>
                            ...
                            {{-- <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleInputOfferType" name="offer_type"
                                            readonly>
                                                    ...
                                                    <select class="form-control  category-select"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                @if ($offer->buyGet->buyCategory_id == $category->id) selected @endif>
                                                    ...
                                                    <select id="items3" class="select2" multiple="multiple" required
                                                        ...
                                                        @foreach ($offer->buyGet->buyCategory->items as $item)
                                                            <option value="{{ $item->id }}"
                                                                @if ($offer->buyGet->buyItems->contains($item)) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="items2" class="select2" multiple="multiple" required
                                                    ...
                                                    @foreach ($offer->buyGet->getCategory->items as $item)
                                                        <option value="{{ $item->id }}"
                                                            @if ($offer->buyGet->getItems->contains($item)) selected @endif>
                                                            {{ $item['name_' . app()->getLocale()] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="exampleInputOfferPrice"
                                                    ...
                                                    <option value="100"
                                                        @if ($offer->buyGet->offer_price == 0) selected @endif>
                                                        Free
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group"> --}}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control category-select"
                                                        id="exampleInputCategory1" name="category_id"
                                                        data-target="items">
                                                        @foreach ($categories as $item)
                                                            <option value="{{ $item->id }}"
                                                                @if ($offer->discount->category->id == $item->id) selected @endif>
                                                                {{ $item['name_' . app()->getLocale()] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleInputDiscountType"
                                                        name="discount_type">
                                                        <option value="1"
                                                            @if ($offer->discount->discount_type == 1) selected @endif>percentage
                                                        </option>
                                                        <option value="2"
                                                            @if ($offer->discount->discount_type == 2) selected @endif>Amount
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $.each(data.data, function(index, item) {
                                $("#items1").append('<option value="' + item.id + '">' + item[
                                        'name_' + '{{ app()->getLocale() }}'] +
                                    '</option>');
                            });
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $.each(data.data, function(index, item) {
                                $("#items2").append('<option value="' + item.id + '">' + item[
                                        'name_' + '{{ app()->getLocale() }}'] +
                                    '</option>');
                            });
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $.each(data.data, function(index, item) {
                                $("#items3").append('<option value="' + item.id + '">' + item[
                                        'name_' + '{{ app()->getLocale() }}'] +
                                    '</option>');
                            });
                        }
