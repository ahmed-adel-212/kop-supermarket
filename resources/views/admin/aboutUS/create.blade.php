                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control p-1 editor" id="description_en" placeholder="Enter Description" name="description_en">{{old('description_en')}}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control p-1 editor" id="description_ar" placeholder="Enter Description" name="description_ar" >{{old('description_ar')}}</textarea>
